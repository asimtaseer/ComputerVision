...
# # blank_image=np.zeros(hight,width)
# converter(gray_image)
# converter(binary_image)
# converter(edge_image)
# converter(image_thickness)
# converter(image_erosion)

h_stack=np.hstack((image,gray_image,binary_image))
h_stack_2=np.hstack((edge_image,image_thickness,image_erosion))
# cv.imshow('all images',h_stack)
